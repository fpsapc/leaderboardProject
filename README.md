...
**[Leaderboard]** is a project that provide user a form. User can fill form and submit it. Given data will be shown as a list using an API.
...
- **[Allow user to add Scores]**
- **[Store scores in an API and display as a list after getting from API]**
...
- [Live Demo Link](https://leaderboard-zxx6.onrender.com/)
...
- **[How this list works]**
  ...
  - [Add your name and score and see it in the list]
